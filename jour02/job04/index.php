    ...
    <p>
      ...
      <div class="row">
        ...
        <div class="input-field col s6">
          ...
          <label for="first_name"><i class="small material-icons">account_box</i>Prénom</label>
        </div>
        <div class="input-field col s6">
          <input id="last_name" type="text" class="validate">
          <label for="last_name"><i class="small material-icons">account_box</i>Nom</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input disabled value="Adresse" id="disabled" type="text" class="validate">
          <label for="disabled"><i class="small material-icons">room</i>Adresse</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="email"><i class="small material-icons">room</i>Email</label>
        </div>
        <div class="row">
          <label>
